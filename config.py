...
WEIGHT_MUTATION_SIGMA = 0.02  # sigma como fração do range do peso
...
LAMBDA_SPECIALIZATION = (
    0.2  # peso da penalidade de homogeneização (specialization_penalty)
)
...
MATCHUP_THRESHOLD = (
    0.10  # excesso acima de 50% que inicia penalização (60% WR = limiar)
)
