...
fighting-game archetypes without destroying their functional identities --- the
tension being that equalizing win rates tends to homogenize a roster. Identity is
...
research question. Balance and identity are optimized as two objectives, by a
...
funcionais} --- a tensão sendo que igualar taxas de vitória tende a homogeneizar o
elenco. A identidade é \emph{medida}, não imposta: o desvio em relação a um perfil
canônico é penalizado de forma suave e o ciclo de vantagens é reportado \emph{post
hoc}, o que evita uma pergunta de pesquisa circular. Equilíbrio e identidade são
otimizados como dois objetivos, por um AG escalar e pelo NSGA-II. Os resultados
preliminares mostram que o \emph{roster} canônico é fortemente desequilibrado
...
\begin{tikzpicture}[
  font=\scriptsize,
  bloco/.style = {draw, rounded corners=1.5pt, align=center, inner sep=2.5pt,
                  text width=52mm, minimum height=6.5mm, fill=white},
  obj/.style   = {draw, rounded corners=1.5pt, align=center, inner sep=2pt,
                  text width=20mm, minimum height=5.5mm, fill=black!8},
  faixa/.style = {draw=black!40, dashed, rounded corners=2pt,
                  inner xsep=4mm, inner ysep=1.5mm},
...
distintos --- semente e \emph{baseline}; o processamento é o laço evolutivo sobre os
dois objetivos; a saída é a fronteira de Pareto. As métricas \emph{post hoc}
(tracejado) incidem sobre a saída e não retornam ao laço, o que sustenta a não
circularidade.}
\label{fig:arq}
\end{figure}
...
\emph{blowout-coinflip} --- cada lado massacrando em metade das partidas, com taxa
de vitória perto de 50\%. Os três compõem
