...
unbalanced (\eqCan{} of 10 balanced matchups); optimizing balance directly reaches
all \eqAg{} but homogenizes the roster (\valAg{} of \valTotal{} identity assertions
preserved), whereas Pareto-front solutions retain up to \valKnee{} of \valTotal{}.
The front makes the trade-off explicit and measurable.
\end{abstract}
...
que o \emph{roster} canônico é fortemente desequilibrado
(\eqCan{} de 10 confrontos equilibrados); otimizar o equilíbrio diretamente alcança
os \eqAg{}, mas homogeneíza o elenco (\valAg{} de \valTotal{} asserções
...
\cite{newzoo2025} ---, a qualidade da experiência depende
...
pergunta. \emph{Medida}, e não imposta, sua preservação --- ou a ausência dela ---
torna-se um
achado genuíno, no espírito de \cite{lehman2011novelty}: não codificar diretamente
o objetivo pode revelar mais sobre o espaço de busca do que otimizá-lo.
...
\end{tikzpicture}
\caption{Arquitetura do sistema. Os arquétipos canônicos entram em dois papéis ---
semente e \emph{baseline}. As métricas \emph{post hoc} (tracejado) incidem sobre a
saída e não retornam ao laço, o que sustenta a não circularidade.}
\label{fig:arq}
\end{figure}
...
quatro oponentes. Seu ótimo é ``nenhum arquétipo domina o
...
define seu arquétipo (17 sobre os genes --- o \emph{rushdown} com a maior
velocidade, o \emph{turtle} com o maior HP --- e 4 sobre o jogo efetivo); a
...
Três delimitações: o modelo simplifica os jogos reais --- não representa
...
reais; e o \emph{round-robin} pressupõe todos jogados em igual proporção, sem
