...
py -m src.tools.multi_run --algorithm ga --lambda-drift 0.25   # braço do sweep de λ (grava em multi_run/lambda_sweep/)
...
| `results/multi_run/lambda_sweep/multi_run_ga_drift<λ>_dom<λ>.json` | braços do sweep de λ (`--lambda-drift`) |
