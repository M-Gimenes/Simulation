...
Uso:
    py -m src.analysis.analyze_matchups                    # todos os matchups (canônico)
    py -m src.analysis.analyze_matchups zoner grappler     # matchup específico
    py -m src.analysis.analyze_matchups --evolved          # usa melhor indivíduo do AG
    py -m src.analysis.analyze_matchups --nsga2 [REP]      # usa representante do NSGA-II
"""
