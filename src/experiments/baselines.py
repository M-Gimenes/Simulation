...
Uso:
    py -m src.experiments.baselines                    # só os baselines
    py -m src.experiments.baselines --evolved          # + posiciona o melhor do AG
    py -m src.experiments.baselines --nsga2 scalar_optimum
    py -m src.experiments.baselines --n-random 60 --sims 400   # mais resolução no p
"""
...
def _build_argparser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--evolved", action="store_true",
                        help="Posiciona o melhor indivíduo do AG (single_run/ga.json)")
