...
#
# Uso:
#   .\scripts\run_battery.ps1                 # roda tudo, na ordem
#   .\scripts\run_battery.ps1 -From 3         # retoma a partir do passo 3
#   .\scripts\run_battery.ps1 -WhatIf         # so lista os passos e o custo
...
foreach ($p in $restantes) {
    ...
    if ($LASTEXITCODE -ne 0) {
        ...
        Write-Host "      .\scripts\run_battery.ps1 -From $($p.N)" -ForegroundColor Red
        exit $LASTEXITCODE
    }
