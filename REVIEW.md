...
decisão, com os números, está em [`docs/tcc/04-caminhos-e-decisoes.md`](docs/tcc/04-caminhos-e-decisoes.md); o estado atual do
sistema, em [`docs/reference/`](docs/reference/README.md). A pauta completa, item a item,
...
| # | Incongruência | Resolução | Onde está o porquê (tcc/04) |
|---|---|---|---|
...
(ver "As constantes provisórias, fechadas com evidência" no tcc/04).
...
[`docs/reference/10-known-issues.md`](docs/reference/10-known-issues.md) §2:
