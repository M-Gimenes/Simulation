...
- **`ACTION_PERSISTENCE_SUBTICKS = 5`** — **[coerência] + [medido]**. 5 = 1 tick = o cooldown
  ...
  ataque; a 10, perdia duas, e a razão sinal/ruído era pior em 8/8 genes. → [04](04-design-decisions.md)
...
- **`stun` como fração do cooldown, em [0, 0,6], timer contínuo** — **[coerência]**. O teto
  ...
  evita que o gene tenha só 4 níveis efetivos. → [04](04-design-decisions.md)
...
- **`MATCHUP_FLOOR = 0,02`** — **[medido]**: base da faixa dos espelhos, abaixo de todo par de
  personagens distintos; é guarda de degenerescência, não de qualidade. → [04](04-design-decisions.md)
...
- **Seed canônico no AG escalar, população aleatória no NSGA-II** — **[medido]**. No NSGA-II o
  ...
  escalar ele ajuda. → [04](04-design-decisions.md) "A população inicial do NSGA-II".
...
- **10 condições na validação externa** — **[projeto]**: 100 oportunidades par × condição de
  ...
  sistemático do esporádico. → [04](04-design-decisions.md) "O veredito da validação externa".
...
- **O NSGA-II entra no teste pelo `best_dominance`** — **[projeto]**, sem registro de porquê. A
  ...
  da próxima bateria. → [04](04-design-decisions.md) "Os cinco representantes".
...
- **Validador de 23 asserções de ranking** (13 estruturais entre personagens, 5 dentro do
  ...
  (quem é o de maior alcance), e distância euclidiana é cega a ranking. → [03](03-fitness-formulation.md).
